    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                       ...
                       <li>
                            <a href="index.php?view=users"><span class="glyphicon glyphicon-user"></span> &nbsp;Administrar Usuarios</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Configuracion</a>
                        </li>                       
                        <li class="divider"></li>
                        <li ><a href="logueo/logout.php"><i class="fa fa-power-off"></i>&nbsp;&nbsp;Cerrar sesión</a></li>
            ...
            <ul class=" nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="#"><span class="glyphicon glyphicon-shopping-cart"></span> &nbsp; Productos</a>
                </li>
                <li>
                    <a href="#"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Contáctenos</a>
                </li>
